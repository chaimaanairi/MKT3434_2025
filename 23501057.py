...
class MLCourseGUI(QMainWindow):
    ...
    def create_classical_ml_tab(self):
        ...
        loss_regression_layout.addWidget(self.loss_combo_reg)
        ...
        svm_reg_group = self.create_algorithm_group(
            "Support Vector Machine (Regression)",
            {"C": "double",
        ...
        loss_classification_layout.addWidget(self.loss_combo_clf)
    ...
    def huber_loss(self, y_true, y_pred, delta=1.0):
        """Calculate the Huber loss for regression"""
        error = y_true - y_pred
    ...
    def train_model(self, model_name, param_widgets):
        ...
        try:
            if model_name == "Linear Regression":
                ...
                loss_function = self.loss_combo_clf.currentText()
    ...
    def load_dataset(self):
        ...
        try:
            ...
            if dataset_name == "Iris Dataset":
                ...
                data = datasets.fetch_california_housing()  # Replace with a non-deprecated dataset
            elif dataset_name == "MNIST Dataset":
                (X_train, y_train), (X_test, y_test) = tf.keras.datasets.mnist.load_data()
                self.X_train, self.X_test = X_train, X_test
                self.y_train, self.y_test = y_train, y_test
